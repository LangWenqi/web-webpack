/**
 * @description: get type of overview
 * @params:{all} overview
 **/
 ...
 * @params:{Object or Array} overview
...
/**
 * @description: to judge if an object or an array is empty or not
...
/**
 * @description: to judge if an object or an array or not
 * @param {all} data
 * @return {Boolean} the result
 **/
...
/**
 * @description: to judge if an object or an array is equal or not
 * @param {all} a
 * @param {all} a
 * @return {Boolean} the result
 **/
...
/**
 * @description: stringify Object or parse Url
